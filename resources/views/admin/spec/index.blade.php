...
@section('content')
    <h1>Specs</h1>
    <p class="lead">In this page you can add the specification that user can assign to a hardware</p>
    ...
    {!! Form::open(['url' => 'admin/specs', 'class' => 'form-inline']) !!}
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <tr>
                <td class="col-md-6 pull-md-none">Spec</td>
            ...
            @foreach($specs as $spec)
                <tr>
                    ...
                    <td>
                        ...
                        {!! Form::open(['url' => 'admin/specs/' . $spec->id, 'method' => 'DELETE', 'class' => 'form-inline form-delete']) !!}
                        <a href="{{ url('/admin/specs/' . $spec->id . '/edit') }}" class="btn btn-warning">Edit</a>
